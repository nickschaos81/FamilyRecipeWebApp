          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="javascript:ColdFusion.navigate('users/profile.cfm', 'page')" title="Profile">Profile</a>
                <a class="dropdown-item" href="javascript:ColdFusion.navigate('users/recipes.cfm', 'page')" title="Recipes">Recipes</a>
